...
import { _storeCurrentConference } from "../../recent-list/actions";
...
export class AbstractWelcomePage extends Component<Props, *> {
  ...
  _onJoin() {
    ...
    const xor = { href: window.location.href + room };
    console.log("yes ok", xor);
    this.props.dispatch(_storeCurrentConference(xor));
    // if (room) {
